...
![900966 Image 782x198.webp](https://s2.loli.net/2025/02/05/k7BrRW2MwdZvLQq.webp)


这是一个工具提示，一般通过简要文字概括，通过光标触发。石墨文档这里不仅在文档协作页面通过这个工具提示，在写作这个特定场景下，满足用户增加缩紧的目标，同时还进一步的引导用户使用快捷键，这是一个高级用户的路径引导。
![img](https://s2.loli.net/2025/02/05/XUk4EIQCaNrwsge.webp)
![img](https://s2.loli.net/2025/02/05/1ujBl3OEcdID45e.webp)

注意到上图中下一步按钮了吧！这是一个新手引导帮助，只存在于「石墨文档」中默认文档「欢迎使用石墨文档」中，用户每次打开这个文档，都会告知新手需要知道的操作，而且是按照步骤来的，流程清晰，好理解，易操作。

![img](https://s2.loli.net/2025/02/05/dtm3vWT7SxLOrCc.webp)
...
![img](https://s2.loli.net/2025/02/05/pa8noRCy2IArOil.webp)

![900966 Image 1200x701.webp](https://s2.loli.net/2025/02/05/mZqASo86fMTcRtd.webp)
